...
replMain :: IO ()
replMain = do
  putStrLn "Welcome to the Cata REPL"
...
type Environment = M.Map String (Either CataTerm T)
...
formatTerm :: CataTerm -> Environment -> CataTerm
