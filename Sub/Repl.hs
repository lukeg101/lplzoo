...
replMain :: IO ()
replMain = do
  putStrLn "Welcome to the Sub REPL"
...
type Environment = M.Map String (Either STerm T)
...
formatTerm :: STerm -> Environment -> STerm
